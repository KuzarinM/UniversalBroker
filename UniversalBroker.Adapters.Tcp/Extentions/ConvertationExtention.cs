...
namespace UniversalBroker.Adapters.Tcp.Extentions
{
    public static class ConvertationExtention
    {
        ...
        public static int GetAttributesFromModel<T>(this T model, RepeatedField<AttributeDto> existing, bool ignoreDefault = true)
        {
                ...
                try
                {
                    if (property.CanRead)
                    {
                            ...
                            propertyType.IsEnum)
                        {
                            ...
                            if (ignoreDefault && value == null && defaultValue == null)
                                continue;

                            if (!ignoreDefault || defaultValue == null || value == null || !defaultValue.Equals(value))
                            {
                                ...
                                updatedCount += existing.AddOrUpdateAttribute(name, valueStr);
                            }
                        }
                    }
                }
